...
export const experiencesData = [
  {
    ...
    location: "Hyderabad, TS",
    description:
      "Built highly interactive and responsive user interfaces following best practices using HTML, CSS, JavaScript, Bootstrap, react, redux, Java, SpringBoot, Microservices.",
